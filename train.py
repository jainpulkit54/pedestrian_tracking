...
parser.add_argument("--pretrained_weights", type = str, default = "checkpoints/yolov3.weights", help = "Path to the pretrained model weights")
...
os.makedirs("checkpoints_YOLOv3_custom", exist_ok = True)
...
def fit(train_loader, val_loader, model, optimizer, n_epochs):
	...
	for epoch in range(n_epochs):
		...
		torch.save({'model_state_dict': model.cpu().state_dict()}, 'checkpoints_YOLOv3_custom/model_epoch_' + str(epoch) + '.pth')
