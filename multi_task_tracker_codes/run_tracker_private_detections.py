...
parser.add_argument("--image_folder", type = str, default = "../marathon/", help = "Path to the dataset folder")
...
parser.add_argument("--tracks_folder_name", type = str, default = "outputs/marathon/tracks_private_detections", help = "Enter the name of the folder where you want to save the tracks obtained")
parser.add_argument("--tracks_file_name", type = str, default = "marathon.txt", help = "Enter the file name in which you want to store the object trajectories")
parser.add_argument("--output_images_folder_name", type = str, default = "outputs/marathon/private_detections", help = "Enter the folder name in which you want to save the images with tracks")
