...
parser.add_argument("--weights_path_reid", type = str, default = "checkpoints_market1501_classification/model_epoch_35.pth", help = "Path to the reid weight file")
